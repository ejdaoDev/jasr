            ...
            <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 d-none d-lg-block"><img src="assets/logoconletras.png" style="width: 420px; height: 420px; margin-left: 70px; margin-top: 20px;"></div>
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <button type="submit" class="btn btn-primary btn-user btn-block">Acceder</button><br>
                                <button type="button" onclick="document.location.href = './'" class="btn btn-secondary btn-user btn-block">Volver</button>
